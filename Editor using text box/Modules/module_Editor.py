...
#   ... for label
    self.frameEditor0 = Frame(
        parentFrame,
        bg='lightblue',
        )
    self.frameEditor0.grid(
        row=0,
        column=0,
        )
#   ... for editor        
    self.frameEditor1 = Frame(
        parentFrame,
        bg='lightblue',
        )
    self.frameEditor1.grid(
        row=1,
        column=0,
        )
        
    self.frameEditor2 = Frame(
        parentFrame,
        bg='lightblue',
        )
    self.frameEditor2.grid(
        row=2,
        column=0,
        )
